...
%
% VERSION NUMBER: 3.02 (9th November, 2012)
%
% REFERENCES:
...
%   To be submitted to Ocean Science. A preliminary version is available at
%   Ocean Sci. Discuss.,6, 215-242.  
...
if any(p < -1.5)
    error('gsw_delta_SA_ref: pressure needs to be positive')
end
