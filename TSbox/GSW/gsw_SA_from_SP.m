...
%
% VERSION NUMBER: 3.02 (5th November, 2012)
%
% REFERENCES:
...
%
%  McDougall, T.J., D.R. Jackett and F.J. Millero, R. Pawlowicz and 
%   P.M. Barker, 2012: An algorithm for estimating Absolute Salinity in the 
%   global ocean. To be submitted to Ocean Science. A preliminary version 
%   is available at Ocean Sci. Discuss.,6, 215-242.  
