...
% CM = ANOM_CMAP(LIMITS)
%
% creates a blue-red colormap to plot negative and positive anomalies
% input LIMITS is a 2 element vector with the upper and the lower limit of
% the colorscale. 
% the ouput CM is a 32 by 3 matrix containg the RGB trios for a blue-red
% colorscale which are distributed such that the white between blue and red
% corresponds to zero.
% 
%
%

function cm = anom_cmap(limits)
