function make_gif_seas_geo_form(ocean,Fpeak,n_stat,prec,evapo,radflux,hflux,temp,sal,tframe,ca_bar,thetaS,thetaT,longsss,longsst)
% %%------------------------Start of Header----------------------------------
%
% ROUTINE                    make_gif_ses_geo_form
...
%             hold off
    ...
    mkdir([original_dir,'\gifs\','seas_form/',tframe,'/',sal,'/',temp,'/',hflux,'/',radflux,'/',evapo,'/',prec,'/',ocean(1:2),'/mc',num2str(n_stat)])
    cd ([original_dir,'\gifs\','seas_form/',tframe,'/',sal,'/',temp,'/',hflux,'/',radflux,'/',evapo,'/',prec,'/',ocean(1:2),'/mc',num2str(n_stat)])
